...
<body>
    ...
    <div id="skills"
        ...
        <?
            ob_start();
            /*
            foreach (executeQuery("SELECT * FROM academic_achievements") as $academic_achievement)
            {
                echo '<div>';
        ...
        ?>
        <div id="academic_achievements"><?=$html_academic_achievements?></div>

        <?
            ob_start();
            $html_professional_experiences = ob_clean();
        ?>
        <div id="professional_experiences"><?=$html_professional_experiences?></div>
    </div>
